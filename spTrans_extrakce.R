spTrans=function(spobj, from=NA, to='wgs'){
  ...
  switch (from, 
          ...
          'wgs_pol'={spobj@proj4string = CRS('+proj=tmerc +lat_0=0 +lon_0=15 +k=1 +x_0=3500000 +y_0=0 +ellps=krass +towgs84=26,-121,-78,0,0,0,0 +units=m +no_defs ')}
  )
  ...
  switch (to, 
          ...
          'rot2' = {crs = CRS(  '+proj=ob_tran +o_proj=longlat +o_lon_p=-170 +o_lat_p=40 +lon_0=180-m 57.2957795130823')},
